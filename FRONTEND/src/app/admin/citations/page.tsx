...
import { BulkCitationImporterDialog, CreateCitationCategoryDialog, CreateCitationDialog, CollectionActions } from "@/components/admin/citation-forms";
    ...
    return (
        <div className="space-y-8">
                                        ...
                                        <Card key={category.id} className="flex flex-col">
                                            <CardHeader>
                                                <div className="flex justify-between items-start">
                                                    <Link href={`/admin/citations/${category.id}`} className="block group flex-1">
            ...
            <div className="fixed bottom-8 right-8 z-50 flex flex-col items-end gap-3">
                ...
                <Button
                size="icon"
                className="h-16 w-16 rounded-full shadow-lg bg-blue-flame"
            ...
            <BulkCitationImporterDialog open={isBulkImportOpen} onOpenChange={setBulkImportOpen} categories={allCitationData}>
                <></>
            ...
            <CreateCitationDialog open={isCreateCitationOpen} onOpenChange={setCreateCitationOpen} categories={allCitationData} />
