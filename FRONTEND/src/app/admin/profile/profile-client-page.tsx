...
import { Bookmark as BookmarkIcon, Star, Users, Building, Camera, Library, BadgeCheck, UserSearch } from 'lucide-react';
...
import { UserFavorites } from '@/app/admin/profile/user-favorites';
import { UserEvolutions } from '@/app/admin/profile/user-evolutions';
...
function CoverPhotoAdjuster({
    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <div 
                ref={containerRef}
                className="relative aspect-[16/9] w-full overflow-hidden bg-muted rounded-lg mx-6"
