    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl">
        ...
        <form action={formAction} ref={formRef} className="space-y-4">
            ...
            <div>
              <Label htmlFor="reasonTags">Reason Tags (comma-separated)</Label>
              <Input id="reasonTags" name="reasonTags" placeholder="e.g., Grammar, Wrong Reading, Text Mistake" defaultValue="Grammar, Wrong Reading, Text Mistake" />
            </div>
