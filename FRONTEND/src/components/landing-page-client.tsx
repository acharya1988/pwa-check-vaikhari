    ...
    <header className="absolute top-0 left-0 right-0 z-50 p-4">
        <div className="container mx-auto flex justify-between items-center">
            <div className="flex items-center gap-2">
                <VaikhariLogo className="h-20 w-20 text-primary" />
                <span className="font-headline text-2xl font-bold">VAIKHARI</span>
            </div>
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
             <div className="relative z-10 text-center md:text-left">
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight">
                    Digital Saraswati Sabha <br />
                </h1>
                <p className="mt-6 max-w-2xl mx-auto md:mx-0 text-lg md:text-xl text-muted-foreground">
                    Unite ancient wisdom with modern technology. VAIKHARI is an AI-powered platform for collaborative research, authoring, and the profound exploration of literature including Sanskrit.
                </p>
                <div className="mt-10">
             ...
             <div className="relative z-10 hidden md:flex justify-center items-center">
                <Image data-ai-hint="man book" src="https://placehold.co/600x500.png" width={600} height={500} alt="Illustration of a person reading" />
            </div>
        </div>
    </section>
);
        ...
        <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto">
                ...
                <p className="mt-4 text-lg text-muted-foreground">
                    VAIKHARI integrates everything you need to research, write, and collaborate on a single, powerful platform.
                </p>
            </div>
...
const LandingFooter = () => (
    <footer className="border-t py-8">
        <div className="container mx-auto text-center text-muted-foreground text-sm">
            <p>&copy; {new Date().getFullYear()} VAIKHARI. All Rights Reserved.</p>
