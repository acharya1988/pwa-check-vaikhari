...
function DeleteLayerButton({ layer, onLayerDeleted }: { layer: LayerAnnotation, onLayerDeleted: () => void }) {
    const { toast } = useToast();
            ...
            <AlertDialogContent>
                <form action={formAction}>
                    ...
                    <div className="space-y-2 py-2">
                        <Label htmlFor={`delete-layer-${layer.id}`}>
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction asChild>
                           <Button type="submit" variant="destructive" disabled={confirmText !== 'DELETE'}>Delete</Button>
                        </AlertDialogAction>
                    </AlertDialogFooter>
                </form>
            </AlertDialogContent>
...
function LayerActions({ layer, onLayerAction }: { layer: LayerAnnotation, onLayerAction: () => void }) {
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent>
                <EditLayerDialog layer={layer} onLayerUpdated={onLayerAction} />
                <DropdownMenuSeparator />
                <DeleteLayerButton layer={layer} onLayerDeleted={onLayerAction} />
            </DropdownMenuContent>
        </DropdownMenu>
    );
}
