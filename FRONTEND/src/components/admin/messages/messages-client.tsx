...
import { ChintanaThreadClient } from '@/app/admin/chintana/[threadId]/chintana-thread-client';
...
function ChatWindow({ item, currentUser, onReplyPosted }: { item: Conversation | ChintanaThread | null, currentUser: UserProfile, onReplyPosted: () => void }) {
    ...
    const [state, formAction] = useActionState(handleSend, null);
    ...
    if (isChintana) {
        return (
            <ChintanaThreadClient 
                thread={item as ChintanaThread} 
         ...
         <div className="h-full flex flex-col">
            ...
            <ScrollArea className="flex-1 p-6 bg-muted/30" ref={messagesAreaRef}>
             ...
             <footer className="p-3 border-t bg-card">
                <form action={formAction} className="max-w-3xl mx-auto flex items-center gap-2">
